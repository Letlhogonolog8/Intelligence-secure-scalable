...
import { loadSession, saveSession, type WASession } from '../utils/whatsappSessionStore';
...
async function getOrCreateSession(phone: string, lang: string): Promise<WASession> {
