...
export class MonitoringDashboard {
  ...
  activeWebSocketConnections = new prometheus.Gauge({
    name: 'aegis_active_websocket_connections',
  ...
  websocketMessagesThroughput = new prometheus.Counter({
    name: 'aegis_websocket_messages_total',
  ...
  recordApiRequest(
    ...
    this.httpRequestDurationMs.observe({ method, route, status_code: statusCode }, durationMs);
  }
  ...
  recordEscalationLatency(durationMinutes: number, responseType: string): void {
    this.escalationLatencyMinutes.observe({ response_type: responseType }, durationMinutes);
  }
