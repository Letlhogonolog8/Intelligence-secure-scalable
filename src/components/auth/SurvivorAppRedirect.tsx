...
export const SurvivorAppRedirect: React.FC = () => {
  ...
  return (
    <main className="min-h-screen bg-[#0B0614] text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-slate-900/60 p-8 text-center shadow-2xl">
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-600 to-pink-500 shadow-lg shadow-purple-600/30">
          <Smartphone className="h-8 w-8" />
        </div>

        <h1 className="text-2xl font-bold">AEGIS Support is a mobile app</h1>
        <p className="mt-3 text-sm leading-relaxed text-slate-300">
          For your privacy and safety, survivor support lives in the dedicated
          AEGIS mobile app — with a calm, discreet design, quick-exit, offline
          access, and an emergency SOS. This website is the portal for support
          professionals.
        </p>
        ...
        <div className="mt-5 flex items-start gap-3 rounded-2xl border border-white/10 bg-white/5 p-4 text-left">
          ...
          <p className="text-xs text-slate-300">
            Your account is the same on both. Sign in on the app with the same
            username and passphrase — your cases and messages are already there.
          </p>
        </div>
        ...
        <div className="mt-6 flex flex-col gap-3">
          {appUrl ? (
            <Button
              className="h-11 bg-gradient-to-r from-violet-600 to-pink-500 font-semibold"
              onClick={() =>
            ...
            <p className="text-xs text-slate-400">
              Ask your support worker or coordinator how to install the AEGIS
              Support app.
            </p>
          )}
          <Button
