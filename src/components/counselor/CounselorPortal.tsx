...
const MOCK_THREADS = [
  {
    name: "Aisha K.",
    tag: "",
    subject: "Follow-up: Counseling Session",
    preview: "Thank you for checking in. I feel safe…",
    time: "10:15 AM",
    count: 2,
    active: true,
  },
  {
    ...
    preview: "We've connected her with a legal aid…",
    time: "09:45 AM",
    count: 1,
  },
  {
    name: "Officer R. Khan (Police)",
    tag: "Police",
    subject: "Case Follow-Up Request",
    preview: "Requesting update on survivor status…",
    time: "Yesterday",
    count: 1,
  },
  {
  ...
  },
  {
    name: "Thabo R. (NGO)",
    tag: "NGO",
    subject: "Shelter Placement Confirmed",
    preview: "She has been placed at Safe Haven…",
    time: "2d ago",
    count: 0,
  },
  {
    name: "AEGIS-AI System",
    tag: "System",
    subject: "Session Reminder",
    preview: "Reminder: You have 2 follow-ups today.",
    time: "2d ago",
    count: 0,
  },
];
...
const MOCK_CHAT = [
  {
    ...
    side: "in",
    time: "10:15 AM",
    text: "Thank you for checking in. I feel safer now, but I still have anxiety at night.",
  },
  {
    from: "You",
    side: "out",
    time: "10:16 AM",
    text: "I'm glad to hear you're feeling safer. Let's talk more about the anxiety and how we can support you.",
  },
  {
    from: "Zanele P. (NGO)",
    side: "in",
    time: "10:18 AM",
    text: "Hi Dr. Sarah, we've arranged for counseling support this week. Please confirm a convenient time.",
  },
  {
    from: "Officer R. Khan (Police)",
    side: "in",
    time: "10:21 AM",
    text: "Please advise if any additional safety measures are needed. We're on standby.",
  },
];

const MOCK_PRIORITY_MSGS = [
  { name: "Aisha K.", time: "10:15 AM", tag: "Critical", count: 2 },
  { name: "Lerato K.", time: "Yesterday", tag: "High", count: 2 },
  { name: "Officer N. Dlamini", time: "Yesterday", tag: "High", count: 1 },
];

const MOCK_ATTACHMENTS = [
  { name: "Safety Plan - Aisha K.pdf", time: "Today 10:14 AM" },
  { name: "Medical Report - Aisha K.pdf", time: "Yesterday 02:30 PM" },
  { name: "Police Report - Case 1187.pdf", time: "May 14, 11:05 AM" },
];
...
const MessagesSection = () => {
  const tabs = ["All", "Unread", "Survivor", "NGO", "Police", "System"];
  return (
    <>
      <section className="grid grid-cols-2 gap-4 xl:grid-cols-4">
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-[300px_1fr_300px]">
        <Panel
          title="Inbox"
          bodyClassName="p-0"
          action={
          ...
          <div className="border-b border-white/5 p-3">
            <div className="relative">
              ...
              <Input
                ...
                className="h-8 border-white/10 bg-slate-900/60 pl-8 text-xs text-white"
              />
            </div>
          ...
          <div className="max-h-[460px] overflow-y-auto">
            {MOCK_THREADS.map((t, i) => (
              <button
                ...
                type="button"
                className={cn(
                  "flex w-full items-start gap-2.5 border-b border-white/5 p-3 text-left hover:bg-white/[0.02]",
                  t.active && "bg-violet-500/5",
                )}
              >
                <Avatar
                  name={t.name}
                ...
                {t.count > 0 && (
                  <span className="grid h-4 w-4 shrink-0 place-items-center rounded-full bg-violet-500 text-[9px] font-black text-white">
                    {t.count}
                  </span>
                )}
              </button>
        ...
        <Panel bodyClassName="p-0">
          <div className="flex items-center justify-between border-b border-white/5 p-4">
            <div className="flex items-center gap-2.5">
              <Avatar name="Aisha K." />
              <div>
                <p className="text-sm font-bold text-white">Aisha K.</p>
                <p className="text-[10px] text-slate-500">
                  Survivor · Case ID: AEG-2026-1187 ·{" "}
            ...
            <div className="flex items-center gap-1.5">
              {[Phone, Video].map((Icon, i) => (
                <button
                  key={i}
                  type="button"
                  className="grid h-8 w-8 place-items-center rounded-lg border border-white/10 text-slate-400 hover:bg-white/5"
                >
                  <Icon className="h-4 w-4" />
                </button>
              ))}
          ...
          <div className="max-h-[380px] space-y-3 overflow-y-auto p-4">
            {MOCK_CHAT.map((m, i) => (
              ...
              >
                ...
                >
                  <p className="mb-0.5 flex items-center justify-between gap-3 text-[10px] opacity-70">
                    {m.from} <span>{m.time}</span>
                  </p>
          ...
          <div className="flex items-center gap-2 border-t border-white/5 p-3">
            ...
            <Input
              ...
              className="h-9 flex-1 border-white/10 bg-slate-900/60 text-sm text-white"
            />
            <button
              type="button"
              className="flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-violet-500 to-indigo-600 px-3 py-2 text-xs font-bold text-white"
            >
        ...
        <div className="flex flex-col gap-6">
          <Panel title="Case Context" action={<LinkChip label="View Case" />}>
            <div className="flex items-center gap-2.5">
              <Avatar name="Aisha K." />
              <div className="min-w-0 flex-1">
                <p className="text-sm font-bold text-white">Aisha K.</p>
            ...
            <div className="mt-3 space-y-1.5 text-[11px]">
              {[
                ["Case ID", "AEG-2026-1187"],
                ["Risk Level", "CRITICAL"],
                ["Violence Type", "Domestic Violence"],
                ["Next Session", "May 16, 10:00 AM"],
              ].map(([l, v]) => (
                <div key={l} className="flex justify-between gap-2">
                  <span className="text-slate-500">{l}</span>
                  <span
          ...
          >
            <p className="text-[10px] text-slate-500">
              Original Language{" "}
              <span className="rounded bg-violet-500/20 px-1 font-bold text-violet-300">
                isiZulu
              </span>
            </p>
            <div className="mt-2 rounded-lg border border-white/10 bg-white/[0.02] p-2 text-[11px] text-slate-400">
              Ngisaba ukuthi angizange ngiphephe. Ngiyacela usizo lokuthi
              ngithole indavo ephephile.
            </div>
            <p className="mt-2 text-[10px] text-slate-500">
              Translated (English){" "}
              <span className="text-emerald-400">Auto-detected</span>
            </p>
            <div className="mt-1 rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-2 text-[11px] text-slate-300">
              I am afraid that I am not safe yet. I am asking for help to find a
              safe place.
            </div>
              ...
              {[
                ...
                return (
                  <button
                    key={i}
                    type="button"
                    className="flex items-center gap-1 rounded-md border border-white/10 px-2 py-1 text-[10px] font-bold text-slate-300 hover:bg-white/5"
                  >
                    <Icon className="h-3 w-3" />
                    {l as string}
                  </button>
            ...
            <div className="space-y-2">
              {MOCK_PRIORITY_MSGS.map((m, i) => (
                <div key={i} className="flex items-center gap-2 text-[11px]">
                  ...
                  <Pill tone={statusTone(m.tag)}>{m.tag}</Pill>
          ...
          >
            <div className="space-y-2">
              {MOCK_ATTACHMENTS.map((a, i) => (
                <div key={i} className="flex items-center gap-2.5">
                  <span className="grid h-7 w-7 shrink-0 place-items-center rounded-lg border border-rose-500/30 bg-rose-500/10 text-rose-300">
      ...
      <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-white/10 bg-slate-900/50 p-3">
        ...
        {[
          ...
          { label: "Reply", icon: ArrowRight },
          { label: "Translate Voice Note", icon: Globe },
          { label: "Share Update", icon: Send },
          { label: "Attach File", icon: Paperclip },
          { label: "Escalate to Team", icon: AlertTriangle },
        ].map((a) => {
          const Icon = a.icon;
          return (
            <button
