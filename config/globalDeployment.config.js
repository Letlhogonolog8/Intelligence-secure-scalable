 ...
 */
export function getEmergencyPhone(countryCode) {
 ...
 */
export function requiresDataResidency(countryCode) {
    return getRegionConfig(countryCode).data_residency_required;
}
/**
 * Get AI model for language
 */
export function getAIModelForLanguage(languageCode) {
...
//# sourceMappingURL=globalDeployment.config.js.map