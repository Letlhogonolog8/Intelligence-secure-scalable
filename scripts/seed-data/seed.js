...
async function ensurePrivilegedTestUsers(adminUserId, organizations) {
    ...
    const usersByEmail = new Map((existing?.users ?? [])
...
async function seedIncidents(regions) {
    ...
    const policies = [
        {
            ...
            description: "Comprehensive GBV training for all police officers on trauma-informed approaches",
            category: "prevention",
            impact_score: 7.5,
        ...
        },
        {
            ...
            description: "Mobile healthcare units for survivors in underserved areas",
            category: "support",
            impact_score: 6.8,
            estimated_cost: "$1.8M",
        ...
        },
        {
            ...
            description: "Gender equality and healthy relationships education in schools",
            category: "prevention",
            impact_score: 8.2,
        ...
        },
        {
            ...
            description: "Expedited court processes for GBV cases with specialized judges",
        ...
        },
        {
            ...
            description: "Multi-media GBV awareness and bystander intervention campaigns",
            category: "prevention",
            impact_score: 6.5,
            estimated_cost: "$900K",
...
async function seedJusticeCases(regions) {
...
async function seedModernCases() {
...
async function seedResources(regions) {
...
async function seedGovernanceData() {
    ...
    if (modelData) {
        ...
        if (metricsError) {
            ...
            console.log(`✅ Created ${fairnessMetrics.length} fairness metrics`);
        }
    }
}
